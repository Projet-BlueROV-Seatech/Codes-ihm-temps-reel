...
CHEMIN_MODELE = r"../modeles/best.pt"
DOSSIER_RESULTATS = r"../resultats_tracking"

try:
    P1     = np.load(os.path.join(DOSSIER_EXTRIN, "P1.npy"))
    P2     = np.load(os.path.join(DOSSIER_EXTRIN, "P2.npy"))
...
if os.path.exists(os.path.join(DOSSIER_ENVIRONNEMENT, "R_redressement.npy")):
    R_redressement = np.load(os.path.join(DOSSIER_ENVIRONNEMENT, "R_redressement.npy"))
    try:
        hauteur_cam1 = np.load(os.path.join(DOSSIER_ENVIRONNEMENT, "hauteur_cam1.npy"))[0]
